...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 3
    actual = count_negatives([42, -12, 15, 17, 29, -40, -57, 82])
    print()
    ...
    # Test 7:
    expected = 6
    actual = count_negatives((-17, -math.pi, -8, -47, -55.555, -48.125))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 2
    seq = [[7, 8, 9], [14, 52], [11], [18, 19, 20, 21]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 3
    seq = [[1, 2], [], ['Zachary', 'Robert', 'Watson'], [31, 42, 77, 74], [3, 5, 9], [12]]
    actual = count_short_ones(seq)
    print()
...
def count_short_ones(seq_of_lists):
    ...
    Type hints:
      ...
      NOTE: Can this really handle tuples? I tried in my test code to write one with tuples and it didn't evaluate.
    """
    # ------------------------------------------------------------------
