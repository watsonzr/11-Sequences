...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([2, 5, 8])
    print()
    print('Test 11 expected:', expected)
    print('        actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 0
    actual = sum_first_n([18, -18, 15, 72, 111, -956, 87, 55], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 31
    actual = sum_first_n([47, -35, 14, 15, -9, 1, 0, -2, 85, 97], 8)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
